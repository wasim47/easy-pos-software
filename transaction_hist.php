	...
	<body>
		...
		<div>
			<div class="row">
				...
				<div class="col-sm-9">
                <h2><strong>Shop Transactions </strong></h2>
				<div class="tab-content">
                <div align="center"> <?php echo $mesg; ?> </div>
					<div class="tab-pane active" id="tabs1-pane1">
						<form class="form-horizontal" role="form" method="post" action="transaction_hist.php" enctype="multipart/form-data" name="test">
                    ...
                    <?php 	$query = "SELECT * FROM hqtransactions where shopid = '".$_POST['shopid']."' order by timedate desc"; //ERE barcode='".$barcode."' ";
							$result = mysql_query($query);
						if(mysql_num_rows($result)>0){
							...
							echo "<thead><th>Barcode</th><th>Item Name</th><th>Item Price</th>
								  <th>Qty Sold</th><th>Total Price</th></tr></thead><tbody>";
							$invtotal = 0;
